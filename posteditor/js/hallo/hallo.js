...
(function () {
    ...
    (function (jQuery) {
        return jQuery.widget("Liip.hallotoolbarlinebreak", {
            ...
            populateToolbar: function (toolbar) {
                ...
                buttonsets = jQuery('.ui-button-set', toolbar);
    ...
    (function (jQuery) {
        ...
        return jQuery.widget('IKS.hallobuttonset', {
            buttons: null,
            _create: function () {
                return this.element.addClass('ui-button-set');
            },
            _init: function () {
                return this.refresh();
            },
    ...
    (function (jQuery) {
        return jQuery.widget('IKS.hallodropdownbutton', {
            ...
            _prepareButton: function () {
                ...
                id = "" + this.options.uuid + "-" + this.options.label;
                classes = [];
                buttonEl = jQuery("<button id=\"" + id + "\"       class=\"" + (classes.join(' ')) + "\" title=\"" + this.options.label + "\">       <span class=\"ui-button-text\">"+ this.options.label +"</span>       </button>");
                if (this.options.cssClass) {
    ...
    */
    ...
    (function (jQuery) {
        return jQuery.widget("IKS.hallofontsize", {
            ...
            populateToolbar: function (toolbar) {
                ...
                var buttonsetHtml = buttonset.html();                
                return toolbar.append(buttonset);
            }
        });
    })(jQuery);
    ...
    // (c) 2016 2j    
    (function (jQuery) {
        return jQuery.widget('IKS.hallosize', {
            options: {
                editable: null,
                toolbar: null,
                uuid: '',
                elements: ["1", "2", "3", "4", "5", "6", "7"],
                buttonCssClass: 'dropfontsize'
            },
            populateToolbar: function (toolbar) {
                var buttonset, contentId, target;
                buttonset = jQuery("<span class=\"" + this.widgetName + "\"></span>");
            ...
            _prepareDropdown: function (contentId) {
                ...
                addElement = function (element) {                    
                    var el, events, queryState;
                    el = jQuery("<button class='fontsizeselector'><span class='menu-item'>"+element+"</span></button>");
                    ...
                    el.on('click', function () {
                        ...
                        /*
                        if (navigator.appName === 'Microsoft Internet Explorer') {
                            _this.options.editable.execute('ForeColor', "<" + tagName + ">");
                            return;
                        }
                        */
                        return _this.options.editable.execute('FontSize', fontSize);
                    });
                    queryState = function (event) {
                        var fontsize;
            ...
            _prepareButton: function (target) {
                ...
                buttonElement.hallodropdownbutton({
                    ...
                    label: 'fontsize',                    
                    target: target,
                    cssClass: 'dropfontsize'//this.options.buttonCssClass
                });
                return buttonElement;
            }
        });
    ...
    // (c) 2016 2j    
    (function (jQuery) {
        return jQuery.widget('IKS.hallocolor', {
            options: {
                editable: null,
                toolbar: null,
                uuid: '',
            ...
            _prepareDropdown: function (contentId) {
                ...
                addElement = function (element) {                    
                    var el, events, queryState;
                    el = jQuery("<button class='colorselector'><span class='menu-item' style='color:"+element+"'>A</span></button>");
                    
                    el.on('click', function () {
                        var fontColor;
                        fontColor = element.toUpperCase();
                        if (el.hasClass('disabled')) {
                            return;
                        }
                        /*
                        ...
                        */
                        return _this.options.editable.execute('forecolor', fontColor);
                    });
                    queryState = function (event) {
                        var color, rgb;
...
function rgb2hex(rgb) {
    ...
    (function (jQuery) {
        return jQuery.widget("IKS.hallofontfamily", {
            options: {
                ...
                fonts: [                    
                    '굴림', '돋움', 
                    'NanumGothic', 'NanumGothicBold', 'NanumBarunGothic', 'NanumBarunGothicBold', 'NanumMyeongjo', 'NanumMyeongjoBold',
                    'DaumRegular', 'DaumSemiBold',
                    'Arial', 'Myriad Pro',        
                    'Tahoma', 'Verdana', 
                    'LatoRegular', 'LatoBold'
                ],
            },
            populateToolbar: function (toolbar) {
                var buttonset, widget,
            ...
            createbuttons: function (buttonset) {
                ...
                jQuery.each(this.options.fonts, function (index) {
                    ...
                    buttonElement.find('.ui-button-text').text(family);
                    buttonset.append(buttonElement);
                });
            },
        });
    ...
    // hallo font backcolor plugin
    // (c) 2016 2j    
    (function (jQuery) {
        return jQuery.widget('IKS.hallobackcolor', {
            options: {
                editable: null,
                toolbar: null,
                uuid: '',
            ...
            _prepareDropdown: function (contentId) {
                ...
                addElement = function (element) {                    
                    var el, events, queryState;
                    el = jQuery("<button class='colorselector'><span class='menu-item' style='background:"+element+"'>A</span></button>");
                    
                    el.on('click', function () {
                        var backColor;
                        backColor = element.toUpperCase();
                        if (el.hasClass('disabled')) {
                            return;
                        }
                        /*
                        ...
                        */
                        return _this.options.editable.execute('backColor', backColor);
                    });
                    queryState = function (event) {
                        var backcolor, rgb;
                        backcolor = document.queryCommandValue("backColor");
                                                
                        if(backcolor.substring(0, 3) == 'rgb'){    
                            if(backcolor.substring(0, 4) == 'rgba'){     
